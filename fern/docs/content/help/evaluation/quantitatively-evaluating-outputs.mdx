...
<Callout intent="info">
  Ragas metrics are designed to evaluate your Retrieval Augmented Generation
  (RAG) systems. To learn more about evaluating RAG pipelines in Vellum, check
  out ![this help center
