...
<Note>For detailed information on configuring metrics, refer to the [Evaluations](/help/evaluation) and [Metrics](/help/metrics) sections in our documentation.</Note>
