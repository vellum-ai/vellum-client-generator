---
title: Webhook Evaluation Metric of LLM Outputs
description: Discover how the Webhook evaluation metric offers a flexible way to assess LLM outputs using business logic for precise quality measurement.
---
