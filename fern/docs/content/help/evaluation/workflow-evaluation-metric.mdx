---
title: LLM Output Evaluation with Workflow Metrics
description: Discover how to set up an Evaluator Workflow for better LLM output scoring, including variable mapping and scoring logic.
---
