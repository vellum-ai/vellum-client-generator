...
To learn how to use evaluators other than Exact Match, see Vellum's [Custom Evaluators](#custom-evaluators).
...
- JSON Validity (best used to ensure JSON output)
- JSON Schema Match (best used to ensure JSON output of a specific structure)
...
It works very similarly as testing prompts, but you're able to create new test cases inline.
