...
Workflow Test Suites can be run from the "Evaluations" tab in the [Workflow Builder](insert url).
![Evaluations Tab](insert url)

Start by attaching a Test Suite to your Workflow.
![Attach Workflow Test Suite](insert url)

The inputs and outputs of your Test Suite must match the inputs and outputs of your Workflow.
If they do not, you will be shown a warning, and your test suite may not run successfully.
![Mismatched Interface Warning](insert url)

After attachinging the workflow, you can run it.
![Run Workflow Test Suite](insert url)
