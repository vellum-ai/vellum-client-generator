...
#### Ask Questions Against a PDF

Concepts: PDF Parsing, Multi-modal File Processing, Data Extraction, Map Nodes

<Accordion title="Example Workflow">
  <iframe
    src="https://app.vellum.ai/public/workflow-deployments/c7d3fe80-6074-4b08-b97d-ea619a220a35"
    width="100%"
    height="450px"
    experimental_enableRequestFullscreen={true}
  />
