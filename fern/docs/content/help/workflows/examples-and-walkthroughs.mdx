...
#### Chatbot with Multiple Sequential Responses and Streaming Outputs

This example demonstrates a chatbot that can say multiple things in a row to a user, instead of the traditional Q&A "ask-and-respond" format. It can be used to improve user experience when the chatbot is performing tasks that take longer to complete. 

Concepts: Chatbots, Chat History Modification, Function Calls, UX Optimization, Streaming

<Accordion title="Example Workflow">
  <iframe
    src="https://app.vellum.ai/public/workflow-deployments/b5f39460-82d3-4192-aeb2-4cc4529445db"
    width="100%"
    height="450px"
    experimental_enableRequestFullscreen={true}
  />
