...
<Accordion title="Tip - JSON Sensitivity in Templating Nodes">
You may have a templating node that outputs JSON which seems valid, but yields the following error when you click “Test” or when you run your workflow:

<img src="https://storage.googleapis.com/vellum-public/help-docs/templating_node_json_sensitivity.png" alt="Templating Node JSON Error" width="60%"/>

<Tip>Templating nodes are sensitive, and require double quotes instead of single quotes whenever working with JSON.</Tip>
...
<iframe
  src="https://app.vellum.ai/public/workflow-deployments/8354c6f2-301b-4f94-b791-824f1b9d152f"
  width="100%"
  height="450px"
></iframe>
...
Set your output type to `JSON` when returning string arrays from Code Execution Nodes, or you'll get the following error: `Failed to execute node Code Execution Node: Mismatched output type: Expected 'ARRAY' but received 'list'`
...
For more on that, see [Quirks and Tips for Handling Functions](http://localhost:3000#quirks-and-tips-for-handling-functions)
...
<iframe
  src="https://app.vellum.ai/public/workflow-deployments/758f46dd-6fe6-4e92-9b0c-3a68025f6287"
  width="100%"
  height="450px"
></iframe>
