...
<div style={{position: "relative", height: "450px"}}>
  <iframe
    id="public-workflow-8c3fac0e-b991-43f5-846a-40a754234feb"
  ...
  <button style={{position: "absolute", top: 0, right: 0}} onClick={() => {
    const iframe = document.getElementById("public-workflow-8c3fac0e-b991-43f5-846a-40a754234feb")?.parentElement;
