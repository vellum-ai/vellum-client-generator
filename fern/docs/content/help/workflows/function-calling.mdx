...
- Passing an Array of multiple function calls with a Code Execution Node
- Extracting a single Function Call with a Code Execution Node
- Extracting a single Function Call with a Templating Node (remember, templating nodes run faster than code execution nodes!)
