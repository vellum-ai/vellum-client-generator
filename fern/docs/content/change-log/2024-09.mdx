...
## New Prompt Caching Columns for Prompt Execution Table

_September 23rd 2024_

You can now see any Prompt Cache Read and Creation Tokens that are passed with your prompt executions. This should allow
you to analyse your prompt caching use, and fine tune it to your expectations. Prompt Caching tokens are limited to Anthropic's
Prompt Caching feature for now.
