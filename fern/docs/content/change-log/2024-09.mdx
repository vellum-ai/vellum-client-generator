...
Models that are now created through the Custom Model Carosel on the [models page](https://app.vellum.ai/models) will have
...
This should enable more cost tracking features for your custom models in the future.
