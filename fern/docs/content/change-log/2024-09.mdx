...
Meta's most recent [Llama 3.2 Vision Instruct](https://fireworks.ai/models/fireworks/llama-v3p2-90b-vision-instruct)

## Private Models Cost Tracking

__September 26th, 2024__

New models that are created through our Private Models workflow should now be created with cost tracking enabled!
