...
---
## Updated Prompt Deployment Executions Table

_September 13th 2024_

We've revamped our Prompt Deployment Executions!

With a switch of data sources, you can now expect improved filtering, ordering, as well as overall improved page load times.
This should enable a smoother experience when working with prompt deployment executions.

Further improvements for this table coming soon!
