...
You can now specify which type of Block should be used as the default throughout the app. Wherever you see the 'Add Block' or 'Add Message' options within a Prompt Editor, your preferred default Block type will be used.

The default setting is "Rich Text", which are the newer of the two Block types and work with Variable Chips. You can still convert individual Blocks between the two types within the Prompt Editor.
