...
You can now see any Prompt Cache Read and Creation Tokens that are passed with your prompt deployment executions. This should allow
you to analyse your prompt caching use, and fine tune to your expectations. Prompt Caching tokens are limited to Anthropic's
