...
We've significantly improved the performance of the Prompt Deployment Executions table. This update brings a dramatic
reduction in load times for filters and sorts; in some instances, dropping 2 minute load times to a few seconds.
...
will enhance your ability to manage, analyze, and optimize your prompt executions.
