...
You can now sort and filter by the Latency field in Workflow Executions! This update allows for better prioritization and
identification of executions with higher or lower latencies, as well as targeting executions within a range of latencies.
We believe these improvements will greatly aid in monitoring and managing workflow executions, providing you with
insights and control over accessing metrics!
