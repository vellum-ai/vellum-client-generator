...
This addition allows for quick identification of the release version associated with each execution. You can find this new column in the Columns dropdown.
