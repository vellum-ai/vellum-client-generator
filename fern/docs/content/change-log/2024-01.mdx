...
There is now native support for setting the `safetySettint` parameters in Google Gemini prompts. You can learn more about how these parameters are used by Google in their docs [here](https://ai.google.dev/api/rest/v1beta/SafetySetting).
