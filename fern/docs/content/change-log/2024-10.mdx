...
## Datadog and Webhook Logging Integrations

**October 15th, 2024**

Logs for your Prompts, Workflows and Documents can now be streamed to Datadog and Webhook destinations!

These integrations provide enhanced logging capabilities, allowing you to stream logs to your preferred logging destinations.

If you'd like to enable these integrations for your Organization, please reach out to us for support.
