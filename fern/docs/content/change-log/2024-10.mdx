...
It could be quite difficult to achieve a perfectly straight line with the "smooth-step" edge type, but those days are behind us, friends.
...
![Edge Snap Magic](https://storage.googleapis.com/vellum-public/help-docs/changelogs/2024-10/EdgeSnap.gif)
...
AutoConnect will automatically connect any unconnected Nodes in your Workflow.
...
<div style="display: grid; grid-template-areas: 'a a / b c'; gap: 12px">
  <div style='grid-area: a'>
    <img src='https://storage.googleapis.com/vellum-public/help-docs/changelogs/2024-10/AutoConnectLayoutAll.gif' />
  </div>
  <div style='grid-area: b'>
    <img src='https://storage.googleapis.com/vellum-public/help-docs/changelogs/2024-10/AutoLayoutSelection.gif' />
  </div>
  <div style='grid-area: c'>
    <img src='https://storage.googleapis.com/vellum-public/help-docs/changelogs/2024-10/AutoConnectSelection.gif' />
  </div>
</div>
