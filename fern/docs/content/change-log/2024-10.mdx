...
In the past, it could be quite difficult to achieve a perfectly straight line with the "smooth-step" edge type, but those days are behind us, friends.
...
![Edge Snap Magic](https://storage.googleapis.com/vellum-public/help-docs/changelogs/2024-10/AutoConnectLayoutAll.gif)
