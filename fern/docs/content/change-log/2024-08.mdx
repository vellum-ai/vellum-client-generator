...
From here, you can edit the JSON schema directly, giving you access to all features supported by the JSON Schema spec that may not yet be supported by our Form component, such
as references:
