...
We are excited to announce that you can now natively specify how prompts handle functions using OpenAI's [tool_choice](https://platform.openai.com/docs/api-reference/chat/create#chat-create-tool_choice)
parameter. By using the tool_choice parameter, you can now dictate exactly when and how tools are employed within your prompts, tailoring interactions to better suit your needs.

![Tool Choice Enablement](https://storage.googleapis.com/vellum-public/help-docs/changelogs/2024-08/tool_choice_parameter.png)

This feature is now available across all OpenAI models that support functions, allowing you to have more precise and effective control of your prompt tools.
