...
You can now see cost tracking in prompt sandboxes, both in the prompt editor and in the comparison tab!
...
If you're curious about the pricing information, feel free to additionally look into a Model's page.
![MLModel Detail Page with Billing Config](mlmodel_detail_page_with_cost_config.png)
