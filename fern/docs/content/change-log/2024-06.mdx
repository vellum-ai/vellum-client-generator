...
You can now provide your own API keys for models that Vellum provides API keys for such as Fireworks hosted Models. To do so, click the 3 dot menu on a Model card and click "Set API Key".

![Workflow Undo Redo](https://storage.googleapis.com/vellum-public/help-docs/changelogs/2024-06/api-key-override.png)
