...
Folder path breadcrumbs on Prompt, Workflow, Test Suite, and Document index pages can now be renamed via right click without navigating to a parent folder! You may also notice that all of the cards on these pages can also be right clicked to access the same options as ir three-dot menus. You'll see more right click menus appearing throughout the app in the coming weeks and months.

![Breadcrumb Context Menus](https://storage.googleapis.com/vellum-public/help-docs/changelogs/2024-06/breadcrum-context-menus.png)
