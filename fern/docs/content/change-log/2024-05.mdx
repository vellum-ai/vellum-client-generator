...
Clicking on the link will take you to the _Prompt's executions_ page, where you can then see all metadata captured for the prompt, including the raw request data sent to the model:
