...
## Function Callin in Prompt Evaluation

Prompts that output function calls can now be evaluated in test suites. This allows users to define expected function call outputs using our first-class display and edit interfaces for evaluating prompts outputting function calls. For more, check out our [docs](/help-center/evaluation/quantitative-evaluation#function-calling).
