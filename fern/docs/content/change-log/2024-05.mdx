...
We have integrated with the LPU Inference Engine, [Groq](https://groq.com/). All public models on Groq are now available to add into your workspace. Be sure to add your api key as a Secret named `GROQ_API_KEY`.
