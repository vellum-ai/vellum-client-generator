...
We've introduced a brand new type of Workflow Node! You can now use Evaluation Metrics inside of workflows with the new Guardrail Node, making it easier to evaluate Workflow steps and to adjust your Workflow's behavior on the fly.
