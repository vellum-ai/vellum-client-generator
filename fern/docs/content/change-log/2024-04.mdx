...
Introducing reusable Evaluation Metrics!

Evaluation Metrics can now be shared across your Test Suites making it easier for you to consistently test and evaluate your Prompt / Workflow performance.
Define a suite of custom metrics tailored to your business logic and use case to save time and ensure standardized evaluations.
