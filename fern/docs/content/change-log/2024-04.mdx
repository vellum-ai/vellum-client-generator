...
We now support models that you've finetuned on [Fireworks AI](https://fireworks.ai/) in Vellum! You can add your finetuned Fireworks model to your workspace by navigating to the [Models](https://app.vellum.ai) page and clicking on the featured Model template at the top.

![Fireworks Model Template](https://storage.googleapis.com/vellum-public/help-docs/fireworks_model_template.png)

Note that we currently only support the Mistral models as the base model. If there are other base models that you would like to see supported, please reach out to us!
