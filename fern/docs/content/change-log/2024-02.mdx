...
Previously you were able to save your workflow execution to a test suite or sandbox scenario from the executions table. Now you could do the same from each execution's details page! Both buttons should now appear on the top right of the execution:
