...
OpenAI's GPT models have traditionally led the way in supporting structured data generation through function calling. But late last year Fireworks AI splashed onto their own function calling model! This model is now available in Vellum for those interested in an open source alternative to GPT.
