...
Building on our recent update that introduced prompt variable chips, we've enhanced the user experience by adding an automatic conversion feature. Now, when you paste a variable within the prompt editor, it is seamlessly transformed into a chip. This improvement ensures consistency and efficiency, reducing manual formatting and potential errors.
