...
We’ve introduced the ability to copy Prompt Variant IDs, Document Indexes, Models, Workflow Names and IDs, Document Keys, and Prompt Names and IDs to clipboard.
