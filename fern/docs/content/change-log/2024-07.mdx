...
![](https://storage.googleapis.com/vellum-public/help-docs/changelogs/2024-07/executions-output-input.png)
![](https://storage.googleapis.com/vellum-public/help-docs/changelogs/2024-07/executions-quality-input.png)
...
## Eval Test Case Uploads

_July 9th, 2024_

We’ve introduced a new feature that allows you to upload test cases directly to an Evaluations table, eliminating the need to navigate to the Test Suite configuration. Now, you'll find an "Upload Test Cases" button in the table header of every Evaluations table, for both Workflows and Prompt Sandboxes.

![](https://storage.googleapis.com/vellum-public/help-docs/changelogs/2024-07/eval-page-test-case-upload.png)
...
![](https://storage.googleapis.com/vellum-public/help-docs/changelogs/2024-07/index-page-list-view.png)
...
![](https://storage.googleapis.com/vellum-public/help-docs/changelogs/2024-07/index-page-collapse.png)
