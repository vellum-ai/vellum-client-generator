...
Previously, loading all Sandbox Evaluations simultaneously caused performance issues and made navigation challenging. To enhance the user experience, we have introduced a searchable select feature. This update allows users to load and view one table at a time, improving performance and ease of use.
