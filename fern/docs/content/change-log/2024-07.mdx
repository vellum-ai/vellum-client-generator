...
OpenAI's newest [GPT-4o Mini models](https://openai.com/index/gpt-4o-mini-advancing-cost-efficient-intelligence/) `gpt-4o-mini` & `gpt-4o-2024-07-18` are now available in Vellum and have been added to all workspaces!
...
<iframe src="https://www.loom.com/embed/fcfdac3f366641b2b8a4104ca73063d7"
  width="100%"
  height="450px"
></iframe>
