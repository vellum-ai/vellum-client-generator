...
Previously, loading all Sandbox Evaluations simultaneously led to poor performance and made navigation difficult. To enhance the user experience, we have updated the page with a searchable select feature. This allows you to easily load and view one table at a time.
