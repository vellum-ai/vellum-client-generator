...
Reorganization of the navigation sidebar to ensure that the tools and features you rely on are more accessible and logically arranged. This restructure is designed to facilitate quicker access and reduce the complexity of navigating through the app.

### Integrated Submenus for Related Items

Submenus within the navigation sidebar for related items such as Sandbox, Evaluations, and Deployments associated with a specific Prompt or Workflow. This integration removes the need to navigate back and forth between top-level items like Prompt or Workflow and the Deployments section. All relevant links are now organized within a cohesive submenu, allowing for smoother transitions and interactions within the context of your work.
