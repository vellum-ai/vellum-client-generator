...
The navigation sidebar has been reorganized to ensure that the tools and features you rely on are more accessible and logically arranged. This restructure is designed to facilitate quicker access and reduce the complexity of navigating through the app.

### Integrated Submenus for Related Items

Prompts and Workflows will now have an integrated submenu within the navigation sidebar for related items such as Sandbox, Evaluations, and Deployments, allowing for smoother transitions and interactions within the context of your work.
