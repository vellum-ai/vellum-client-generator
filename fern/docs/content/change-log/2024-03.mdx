...
We have introduced a new debugging feature for code execution eval metrics! You can click the new "Test" button in the full-screen editor and test your code without having to run the whole test suite! Then you can further iterate on your code by modifying your test data in the "Test Data" tab.
