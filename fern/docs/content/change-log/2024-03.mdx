...
Looking for more room to edit your scenarios in the prompt sandbox? We've just added an expand scenario modal to easily make changes to scenarios with longer inputs.
