...
The Test Cases Table on the Test Suites page has been updated to use the same new styling and functionality as the Test Cases Table that you'll find on Evaluation Reports!
