...
To use this feature, drag a publicly hosted image url (that includes one of OpenAI's acceptable image formats) into a Prompt or Workflow scenario's Chat History message in the Sandbox.
...
![Image Support in Vellum UI](https://storage.googleapis.com/vellum-public/help-docs/images-in-prompts.gif)
