...
To help you find your way in large and complex workflows we have added a new search feature to workflows. Click the new search icon in the top right to quickly find the node you are looking for, or use the `⌘ + shift + F` shortcut (`ctrl + shift + F` on windows).
