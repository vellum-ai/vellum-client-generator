...
We've made some significant changes to enhance your navigation experience within our app:

- Revised Navigation Sidebar: We've undertaken a comprehensive reorganization of the navigation sidebar to ensure that the tools and features you rely on are more accessible and logically arranged. This restructure is designed to facilitate quicker access and reduce the complexity of navigating through the app.

- Integrated Submenus for Related Items: To further refine your navigation experience, we've introduced submenus within the navigation sidebar for related items such as Sandbox, Evaluations, and Deployments associated with a specific Prompt or Workflow. This integration removes the need to navigate back and forth between top-level items like Prompt or Workflow and the Deployments section. All relevant links are now organized within a cohesive submenu, allowing for smoother transitions and interactions within the context of your work.

| Revised Sidebar                                                                                | Integrated Submenu                                                                                   |
| ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| ![Revised Sidebar](https://storage.googleapis.com/vellum-public/help-docs/revised-sidebar.png) | ![Integrated Submenu](https://storage.googleapis.com/vellum-public/help-docs/integrated-submenu.png) |

These enhancements are part of our commitment to continually improving the user experience within our app. By making these changes, we aim to simplify your workflow, reduce navigation time, and improve overall efficiency.
