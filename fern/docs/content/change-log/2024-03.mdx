...
You can now view Workflow execution details from the Workflow Evaluations table! Click the new workflow icon in a test case's value to open up the details view.

![Workflow Executions1](https://storage.googleapis.com/vellum-public/help-docs/workflow-evaluation-details)
![Workflow Executions2](https://storage.googleapis.com/vellum-public/help-docs/workflow-evaluation-details2)
